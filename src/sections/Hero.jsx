...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center animate-pulse">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 animation-fade-in animation-delay-300">
              ...
              <a href="/cv.pdf" download="Sipho_Msiza_CV.pdf">
            ...
            <div className="flex items-center gap-4 animation-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/SiphoMsiza1998" },
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/in/siphojacobmsiza",
                },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
                  className=" p-2 rounded-full glass hover:text-primary bg-primary/10 transition-all duration-300"
                >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animation-fade-in animation-delay-800">
        <a
          href="#about"
